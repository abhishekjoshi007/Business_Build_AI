      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group bg-gray-900 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:transform hover:scale-105 border border-gray-800 hover:border-purple-500/50"
            >
              <div className="relative h-48 overflow-hidden">
                <div
                  className="absolute inset-0 bg-gradient-to-br from-black via-transparent to-purple-900/50 z-10 
                  group-hover:from-purple-900/20 group-hover:to-black transition-all duration-500"
                ></div>
                <img
                ...
                <div
                  ...
                  backdrop-blur-sm group-hover:bg-purple-900/50 transition-all duration-300"
                >
                  {service.icon}
                </div>
              </div>
              <div className="p-6">
                ...
                <a
                  ...
                  className={`block w-full py-2.5 rounded-md bg-gradient-to-r ${service.color} ${service.hoverColor} 
                    transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg hover:shadow-purple-500/25 text-center`}
                >
                  Try Now
                </a>
              </div>
