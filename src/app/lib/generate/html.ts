...
import { generateReviewSection } from './review-form'
...
export async function generateHTML(props: SiteContent, bucketName: string, hasSSL: boolean) {
  ...
  const contactFormHTML = generateContactFormSection({
  ...
  const html = `
      ...
      <html lang="en">
        <head>
          ...
          <meta name="description" content="${metaDescription || 'Generated by Build Business AI. Visit us to create your own free website today!'}">
          <meta name="author" content="${metaAuthor || 'Build Business AI'}">
          <meta property="og:title" content="${title}">
          <meta property="og:description" content="${metaDescription || 'Generated by Build Business AI. Visit us to create your own free website today!'}">
          <meta property="og:image" content="${aboutUsImageURL || ''}">
          <meta property="og:url" content="${websiteUrl || ''}">
          <meta property="og:type" content="website">
          <meta name="twitter:card" content="summary_large_image">
          <meta name="twitter:title" content="${title}">
          <meta name="twitter:description" content="${metaDescription || 'Generated by Build Business AI. Visit us to create your own free website today!'}">
